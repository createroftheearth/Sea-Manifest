    ...
    public class MessageImplementationService
    {
        ...
        public byte[] GetMessageJson(int iMessageImplementationId)
        {
            ...
            using (var db = new SeaManifestEntities())
            {
                ...
                else if (query.Any(z => z.sDecRefReportingEvent == "SDM"))
                {
                    Json = JsonConvert.SerializeObject(query.ToList().Select(z => new SDM_JsonModel
                    {
                        HeaderField = new HeaderField
                        {
                            date = z.dtHeaderFieldDateTime?.ToString("yyyyMMdd", CultureInfo.InvariantCulture),
                        ...
                        masterm = new MasterM
                        {
                            ...
                            mastrCnsgmtDec = z.tblMasterConsignmentMessageImplementationMaps.Select(m => new MastrCnsgmtDec
                            {
                                ...
                                houseCargoDec = m.tblHouseCargoDescriptionMasterConsignmentMaps.Select(h => new HouseCargoDec
                                {
                                    ...
                                    itemDtls = h.tblItemDetailsHouseCargoMaps.Select(i => new ItemDtl2
                                    {
                                        crgoItemSeqNmbr = Convert.ToInt32(i.dCargoItemSequenceNo),
                                        hsCd = i.sHsCd,
                                        imdgCd = i.sIMDGCd,
                                    ...
                                    itnry = h.tblItineraryHouseCargoMaps.Select(ii => new Itnry2
                                    {
                                        modeOfTrnsprt = ii.sModeOfTransport,
                                        nxtPrtOfCallCdd = ii.sNextPortOfCallCdd,
                                        nxtPrtOfCallName = ii.sNextPortOfCallCdd,
                                    ...
                                    trnsprtDocMsr = new TrnsprtDocMsr2
                                    {
                                        crncyCd = h.sTrnsprtrDocMsrCurrencyCd,
                                        grossWeight = Convert.ToInt32(h.dTrnsprtrDocMsrGrossWeight),
                                        invoiceValueOfCnsgmt = Convert.ToInt32(h.dTrnsprtrDocMsrInvoiceValueOfConsigment),
                                    ...
                                    trnsprtEqmt = h.tblTransportEquipmentHouseCargoMaps.Select(e => new TrnsprtEqmt2
                                    {
                                        adtnlEqmtHold = e.sAdditionalEquipmentHold,
                                        cntrAgntCd = e.sContainerAgentCd,
                                        cntrWeight = Convert.ToInt32(e.dContainerWeight),
                                ...
                                itemDtls = m.tblItemDetailsMasterConsignmentMaps.Select(i => new ItemDtl
                                {
                                    ...
                                    hsCd = i.sHsCd,
                                    imdgCd = i.sIMDGCd,
                                    nmbrOfPkgs = Convert.ToString(i.dNoOfPakages),
                                    typOfPkgs = i.sTypesOfPackages,
                                    unoCd = i.sUnoCd,
                                    crgoItemDesc = i.sCargoItemDesc,
                                }).ToList(),
                ...
                else if (query.Any(z => z.sDecRefReportingEvent == "SDN"))
                {
                    Json = JsonConvert.SerializeObject(query.ToList().Select(z => new SDN_JsonModel
                    {
                        HeaderField = new HeaderFieldN
                        {
                            date = z.dtHeaderFieldDateTime?.ToString("yyyyMMdd", CultureInfo.InvariantCulture),
                            time = "T" + z.dtHeaderFieldDateTime?.ToString("hh:mm", CultureInfo.InvariantCulture),
                            reportingEvent = z.sDecRefReportingEvent,
                        ...
                        master = new MasterN
                        {
                            ...
                            vesselDtls = new VesselDtlsN
                            {
                                modeOfTrnsprt = z.sVesselDtlsModeOfTransport,
                                trnsprtMeansId = z.sVesselDtlsTransportMeansId,
                                typOfTrnsprtMeans = z.sVesselDtlsTypeOfTransportMeans
                            },
                            arvlDtls = new ArvlDtlsN
                            {
                                nmbrOfPsngrs = Convert.ToInt32(z.iArvlDtlsNumberOfPassengers),
                                nmbrOfCrew = Convert.ToInt32(z.iArvlDtlsNumberOfCrew),
                                lightHouseDues = Convert.ToInt32(z.iArvlDtlsLightHouseDues),
                                totalNoOfCntrsLanded = Convert.ToInt32(z.iArvlDtlsTotalNoOfCntrsLanded),
                                totalNoOfCntrsLoaded = Convert.ToInt32(z.iArvlDtlsTotalOfCntrsLoaded),
                                totalNmbrOfPrsnsOnBoard = Convert.ToInt32(z.iArvlDtlsTotalNoOfPersonOnBoard),
                                totalNoOfTrnsprtEqmtRprtdOnArvlDptr = Convert.ToInt32(z.iArvlDtlsTotalNoOfTrnsprtEqReprtdOnArrDptr),
                                totalNmbrOfTrnsprtContractsRprtdOnArvlDptr = Convert.ToInt32(z.iArvlDtlsTotalNoOfTrnsprtCntrctReprtdOnArrDptr1)
                            },
                            //voyageDtls = new VoyagedtlsN
                            //{
                            //    briefCrgoDesc = z.sVoyageDtlsBriefCargoDesc,
                            //    cnvnceRefNmbr = z.sVoyageDtlsConveinceRefNo,
                            //    crgoDescCdd = z.sVoyageDtlsCargoDesCdd,
